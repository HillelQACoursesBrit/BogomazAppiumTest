...
public class ExampleTest {
        ...
        public void checkItemInBasketTest() {
            ...
            Assert.assertEquals(driver.findElementById("ua.com.rozetka.shop:id/item_cart_offer_tv_title").getText(),"Мобильный телефон Samsung Galaxy M21 4/64GB Black (SM-M215FZKUSEK)");
        }
